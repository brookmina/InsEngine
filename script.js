        ...
        const app = createApp({
            ...
            setup() {
                ...
                const products = {
                    ...
                    'AFTL0': { id: 'AFTL0', company: '三商美邦', shortName: '安家福貸', name: '安家福貸平準型定期壽險(期繳)', planType: '主約', insType: '壽險', saleStatus: '現售', tags: ['定期壽險'], term: '20年期', unit: '萬元', amount: '200', premium: '4,600', features: ['平準型保障'], rules: '依規定', termsContent: '詳見條款' },
                    'NFA': { id: 'NFA', company: '新光人壽', shortName: '誠新誠意', name: '誠新誠意終身保險(11302)', planType: '主約', insType: '壽險', saleStatus: '現售', tags: ['終身壽險'], term: '20年期', unit: '萬元', amount: '100', premium: '107,600', features: ['終身保障'], rules: '依規定', termsContent: '詳見條款' },
                    'OEA': { id: 'OEA', company: '新光人壽', shortName: 'MTR定期壽', name: 'MTR多型態定期壽險附約(新定義)(甲型)(11412)', planType: '附約', insType: '壽險', saleStatus: '現售', tags: ['定期壽險'], term: '10年期', unit: '萬元', amount: '100', premium: '4,980', features: ['定期保障'], rules: '依規定', termsContent: '詳見條款' }
                };
